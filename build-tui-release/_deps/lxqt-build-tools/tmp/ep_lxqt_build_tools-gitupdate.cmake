...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "2.1.0"
  WORKING_DIRECTORY "/home/primo/Work/repos/Devpad/build-tui-release/_deps/lxqt-build-tools/src/ep_lxqt_build_tools"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("2.1.0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 2.1.0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/2.1.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"2.1.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/primo/Work/repos/Devpad/build-tui-release/_deps/lxqt-build-tools/src/ep_lxqt_build_tools'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/primo/Work/repos/Devpad/build-tui-release/_deps/lxqt-build-tools/src/ep_lxqt_build_tools'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
