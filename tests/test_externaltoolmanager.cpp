...
{
    EXPECT_EQ(manager.resolveVariables("%f", "/home/user/file.cpp", "/home/user/project", "selected", 10),
              "/home/user/file.cpp");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesBaseName)
{
    EXPECT_EQ(manager.resolveVariables("%n", "/home/user/file.cpp", "", "", 0),
              "file");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesDirectory)
{
    EXPECT_EQ(manager.resolveVariables("%d", "/home/user/file.cpp", "", "", 0),
              "/home/user");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesExtension)
{
    EXPECT_EQ(manager.resolveVariables("%e", "/home/user/file.cpp", "", "", 0),
              ".cpp");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesProjectDir)
{
    EXPECT_EQ(manager.resolveVariables("%p", "", "/home/user/project", "", 0),
              "/home/user/project");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesSelectedText)
{
    EXPECT_EQ(manager.resolveVariables("%s", "", "", "selected_text", 0),
              "selected_text");
}

TEST_F(ExternalToolManagerTest, ResolveVariablesLineNumber)
{
    EXPECT_EQ(manager.resolveVariables("%l", "", "", "", 42),
              "42");
}
...
TEST_F(ExternalToolManagerTest, ResolveVariablesComplexTemplate)
{
    ...
    EXPECT_EQ(manager.resolveVariables("%n at %d", "/path/to/script.py", "", "", 0),
              "script at /path/to");
}
