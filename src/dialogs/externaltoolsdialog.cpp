...
void ExternalToolsDialog::setupUI()
{
    ...
    m_table->setHorizontalHeaderLabels({
        tr("Name"), tr("Command"), tr("Arguments"), tr("Shortcut"), tr("Terminal")
    });
    ...
    connect(m_addButton, &QPushButton::clicked, this, [this, setRowFromTool]() {
    ...
    connect(m_editButton, &QPushButton::clicked, this, [this, getToolFromRow, setRowFromTool]() {
