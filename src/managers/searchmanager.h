...
public:
    ...
    void setLastSearch(const QString &text, bool useRegex = false,
...
private:
    void performSearch(const QString &text, bool regex, bool caseSensitive,
                       bool wholeWord, bool searchForward);
