...
const ThemeApplicator& javascriptThemeApplicator()
{
    static const ThemeApplicator fn = [](QsciLexer* lexer, const ThemeColors& colors)
    {
        ...
        l->setColor(colors.comment, QsciLexerJavaScript::CommentDoc);
        l->setColor(colors.comment, QsciLexerJavaScript::CommentLineDoc);
        ...
        l->setColor(colors.string, QsciLexerJavaScript::UnclosedString);
        l->setColor(colors.number, QsciLexerJavaScript::Number);
        l->setColor(colors.foreground, QsciLexerJavaScript::Regex);
        l->setColor(colors.operator_, QsciLexerJavaScript::Operator);
...
const std::vector<LanguageInfo>& languageTable()
{
    static const std::vector<LanguageInfo> table = {
        {"cpp",
         "QsciLexerCPP",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerCPP(parent); },
         cppKeywords,
         cppThemeApplicator(),
         {"//", "/*", "*/"}},
        {"c",
        ...
        {"csharp",
         "QsciLexerCSharp",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerCSharp(parent); },
         csharpKeywords,
         csharpThemeApplicator(),
         {"//", "/*", "*/"}},
        {"java",
         "QsciLexerJava",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerJava(parent); },
         javaKeywords,
         javaThemeApplicator(),
         {"//", "/*", "*/"}},
        {"python",
         "QsciLexerPython",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerPython(parent); },
         pythonKeywords,
        ...
        {"javascript",
         ...
         javascriptKeywords,
         javascriptThemeApplicator(),
         {"//", "/*", "*/"}},
        {"html",
         "QsciLexerHTML",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerHTML(parent); },
         htmlKeywords,
         htmlThemeApplicator(),
         {"", "<!--", "-->"}},
        {"htm",
        ...
        {"css",
         "QsciLexerCSS",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerCSS(parent); },
         cssKeywords,
         cssThemeApplicator(),
         {"//", "/*", "*/"}},
        {"xml",
         "QsciLexerXML",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerXML(parent); },
         xmlKeywords,
         xmlThemeApplicator(),
         {"", "<!--", "-->"}},
        {"sql",
         "QsciLexerSQL",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerSQL(parent); },
         sqlKeywords,
         sqlThemeApplicator(),
         {"--", "/*", "*/"}},
        {"json",
        ...
        {"markdown",
         "QsciLexerMarkdown",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerMarkdown(parent); },
         markdownKeywords,
        ...
        {"cmake",
         "QsciLexerCMake",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerCMake(parent); },
         cmakeKeywords,
         cmakeThemeApplicator(),
         {"#", "#[[", "]]"}},
        {"bash",
         "QsciLexerBash",
         []([[maybe_unused]] QObject* parent) -> QsciLexer* { return new QsciLexerBash(parent); },
         bashKeywords,
         bashThemeApplicator(),
         {"#", "", ""}},
        {"lua",
