...
void ProjectPanel::buildRecentFoldersMenu(QMenu* menu) const
{
...
void ProjectPanel::openInTerminal(const QString& dirPath)
{
    ...
    if (terminalBase == "gnome-terminal" || terminalBase == "kgx" || terminalBase == "xfce4-terminal" || terminalBase == "alacritty" ||
