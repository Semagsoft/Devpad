...
TerminalBackendKodoTerm::TerminalBackendKodoTerm(QWidget *parent)
...
void TerminalBackendKodoTerm::applyTheme(const QString &schemeName)
{
    ...
    Q_UNUSED(schemeName)
    TerminalTheme theme;
    if (schemeName.contains("Dark", Qt::CaseInsensitive) ||
        schemeName.contains("Nord", Qt::CaseInsensitive) ||
        schemeName.contains("Monokai", Qt::CaseInsensitive) ||
        schemeName.contains("Gruvbox", Qt::CaseInsensitive) ||
        schemeName.contains("Mocha", Qt::CaseInsensitive) ||
        schemeName.contains("Macchiato", Qt::CaseInsensitive) ||
        schemeName.contains("Dracula", Qt::CaseInsensitive) ||
        schemeName.contains("OneDark", Qt::CaseInsensitive) ||
        schemeName.contains("TokyoNight", Qt::CaseInsensitive) ||
        schemeName.contains("AyuDark", Qt::CaseInsensitive)) {
