...
public:
    ...
    void clearSelection();
    int selectionAnchorLine() const
    {
        return m_selAnchorLine;
    }
    int selectionAnchorCol() const
    {
        return m_selAnchorCol;
    }
    ...
    {
        return m_autoCloseBrackets;
    }
    void setAutoCloseBrackets(bool v)
    {
        m_autoCloseBrackets = v;
    }
