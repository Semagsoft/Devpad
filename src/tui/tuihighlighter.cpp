...
QString TuiHighlighter::languageForFile(const QString& filePath)
{
    ...
    static const QHash<QString, QString> extMap = {
        {QStringLiteral("cpp"), QStringLiteral("cpp")},       {QStringLiteral("cc"), QStringLiteral("cpp")},
        {QStringLiteral("cxx"), QStringLiteral("cpp")},       {QStringLiteral("h"), QStringLiteral("cpp")},
        {QStringLiteral("hpp"), QStringLiteral("cpp")},       {QStringLiteral("c"), QStringLiteral("cpp")},
        {QStringLiteral("cs"), QStringLiteral("csharp")},     {QStringLiteral("java"), QStringLiteral("java")},
        {QStringLiteral("py"), QStringLiteral("python")},     {QStringLiteral("js"), QStringLiteral("javascript")},
        {QStringLiteral("ts"), QStringLiteral("typescript")}, {QStringLiteral("html"), QStringLiteral("html")},
        {QStringLiteral("htm"), QStringLiteral("html")},      {QStringLiteral("css"), QStringLiteral("css")},
        ...
        {QStringLiteral("json"), QStringLiteral("json")},     {QStringLiteral("jsonc"), QStringLiteral("jsonc")},     {QStringLiteral("qml"), QStringLiteral("qml")},
...
const QStringList& TuiHighlighter::keywordsForLang(const QString& lang)
{
    ...
    if (lang == QStringLiteral("cpp"))
        src = &cppKeywords();
    else if (lang == QStringLiteral("csharp"))
        src = &csharpKeywords();
        ...
        src = &javascriptKeywords();
    else if (lang == QStringLiteral("html"))
        src = &htmlKeywords();
        ...
        src = &sqlKeywords();
    else if (lang == QStringLiteral("typescript"))
        src = &typescriptKeywords();
    else if (lang == QStringLiteral("rust"))
        src = &rustKeywords();
    else if (lang == QStringLiteral("go"))
        src = &goKeywords();
