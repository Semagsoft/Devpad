...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerlua.h"
...
namespace {
struct qt_meta_tag_ZN12QsciLexerLuaE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerLua::qt_create_metaobjectdata<qt_meta_tag_ZN12QsciLexerLuaE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerLua, qt_meta_tag_ZN12QsciLexerLuaE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerLua::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerLuaE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerLuaE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12QsciLexerLuaE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerLua::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerLuaE_t>.strings))
