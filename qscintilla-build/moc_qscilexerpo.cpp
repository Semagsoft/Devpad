...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerpo.h"
...
namespace {
struct qt_meta_tag_ZN11QsciLexerPOE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerPO::qt_create_metaobjectdata<qt_meta_tag_ZN11QsciLexerPOE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerPO, qt_meta_tag_ZN11QsciLexerPOE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerPO::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QsciLexerPOE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QsciLexerPOE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11QsciLexerPOE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerPO::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QsciLexerPOE_t>.strings))
