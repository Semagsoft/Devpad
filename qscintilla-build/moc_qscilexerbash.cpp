...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerbash.h"
...
namespace {
struct qt_meta_tag_ZN13QsciLexerBashE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerBash::qt_create_metaobjectdata<qt_meta_tag_ZN13QsciLexerBashE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerBash, qt_meta_tag_ZN13QsciLexerBashE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerBash::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerBashE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerBashE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QsciLexerBashE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerBash::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerBashE_t>.strings))
