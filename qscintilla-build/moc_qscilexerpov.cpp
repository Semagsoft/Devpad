...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerpov.h"
...
namespace {
struct qt_meta_tag_ZN12QsciLexerPOVE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerPOV::qt_create_metaobjectdata<qt_meta_tag_ZN12QsciLexerPOVE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerPOV, qt_meta_tag_ZN12QsciLexerPOVE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerPOV::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerPOVE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerPOVE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12QsciLexerPOVE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerPOV::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12QsciLexerPOVE_t>.strings))
