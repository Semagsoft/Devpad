...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerd.h"
...
namespace {
struct qt_meta_tag_ZN10QsciLexerDE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerD::qt_create_metaobjectdata<qt_meta_tag_ZN10QsciLexerDE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerD, qt_meta_tag_ZN10QsciLexerDE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerD::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QsciLexerDE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QsciLexerDE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10QsciLexerDE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerD::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10QsciLexerDE_t>.strings))
