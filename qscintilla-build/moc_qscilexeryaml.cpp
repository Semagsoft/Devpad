...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexeryaml.h"
...
namespace {
struct qt_meta_tag_ZN13QsciLexerYAMLE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerYAML::qt_create_metaobjectdata<qt_meta_tag_ZN13QsciLexerYAMLE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerYAML, qt_meta_tag_ZN13QsciLexerYAMLE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerYAML::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerYAMLE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerYAMLE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QsciLexerYAMLE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerYAML::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerYAMLE_t>.strings))
