...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexercmake.h"
...
namespace {
struct qt_meta_tag_ZN14QsciLexerCMakeE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerCMake::qt_create_metaobjectdata<qt_meta_tag_ZN14QsciLexerCMakeE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerCMake, qt_meta_tag_ZN14QsciLexerCMakeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerCMake::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QsciLexerCMakeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QsciLexerCMakeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14QsciLexerCMakeE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerCMake::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14QsciLexerCMakeE_t>.strings))
