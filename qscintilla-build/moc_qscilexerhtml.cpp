...
#include "../build/_deps/qscintilla/src/ep_qscintilla/src/Qsci/qscilexerhtml.h"
...
namespace {
struct qt_meta_tag_ZN13QsciLexerHTMLE_t {};
} // unnamed namespace

template <> constexpr inline auto QsciLexerHTML::qt_create_metaobjectdata<qt_meta_tag_ZN13QsciLexerHTMLE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QsciLexerHTML, qt_meta_tag_ZN13QsciLexerHTMLE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QsciLexerHTML::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexer::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerHTMLE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerHTMLE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13QsciLexerHTMLE_t>.metaTypes,
    nullptr
} };
...
void *QsciLexerHTML::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13QsciLexerHTMLE_t>.strings))
